...
public class BranchForm extends javax.swing.JFrame {
    ...
    public void addManagerItemCombo(){
       try {
           ...
           List<Manager> managers = service.allManager();
           for(Manager manObj: managers){
           managerCombo.addItem(manObj);
           }
    ...
    public void addData(){
         try {
            ...
            List<Branch> branchObj = service.allBranch();
              tableModel.setRowCount(0);
              if(branchObj!=null){
           for(Branch br: branchObj){
              Object data[]={
                  br.getId(),
                  br.getNames(),
                  br.getManager(),
    ...
    private void initComponents() {
        ...
        searchBranchTxt = new javax.swing.JTextField();
        ...
        managerCombo.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(managerCombo, 0, 355, Short.MAX_VALUE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(206, 206, 206)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(managerCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(68, 68, 68)
        ...
        searchBranchTxt.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        jLabel11.setFont(new java.awt.Font("Mongolian Baiti", 1, 20)); // NOI18N
        jLabel11.setText("Search for branch:");
        ...
        branchTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Branch ID", "Branch Name", "Manager Name", "Started Date"
            }
        ));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(56, 56, 56)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(searchBranchTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 355, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel11)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(searchBranchTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(13, 13, 13)
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        try {
            ...
            BranchService service =(BranchService) theRegistry.lookup("branch");
            Branch theBranch = new Branch();
            theBranch.setId(Integer.parseInt(searchBranchTxt.getText()));
            Branch brObj = service.searchBranch(theBranch);
            if (brObj != null) {
                searchBranchTxt.setText(String.valueOf(brObj.getId()));
                nameTxt.setText(brObj.getNames());
                managerCombo.setSelectedItem(brObj.getManager());
            } else {
                JOptionPane.showMessageDialog(this, "Data not found");
            }
        } catch (Exception e) {
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        try{
            ...
            Branch brObj = service.updateBranch(theBranch);
            if(brObj!=null){
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        try{
           Registry theRegistry = LocateRegistry.getRegistry("127.0.0.1",6000);
            ...
            Branch brObj = service.deleteBranch(theBranch);
            if(brObj!=null){
    ...
    private javax.swing.JTextField searchBranchTxt;
